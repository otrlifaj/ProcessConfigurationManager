...
{
    [Serializable]
    public class ActivityDiagramNodeData : GraphLinksModelNodeData<String>
    {
        ...
        public String Color { 
            get {
             switch (Stereotype)
             {
                 case "<<Process>>": return "LightBlue";
                     break;
                 case "<<Task>>": return "LightGreen";
                     break;
                 case "<<Alternative>>": return "Cyan";
                     break;
                 case "<<Group>>": return "LightGray";
                     break;
                 case "<<Role>>": return "SkyBlue";
                     break;
                 case "<<Competence>>": return "LightYellow";
                     break;
                 case "<<Law>>": return "LightGreen";
                     break;
                 case "<<Issue>>": return "PowderBlue";
                     break;
                 case "<<Event>>": return "PeachPuff";
                     break;
                 case "<<Context>>": return "LightGray";
                     break;
                 case "<<Goal>>": return "YellowGreen";
                     break;
                 case "<<Intention>>": return "SandyBrown";
                     break;
                 case "<<Argument>>": return "Tomato";
                     break;
                 case "<<Object>>": return "Teal";
                     break;
                 case "<<Entity>>": return "Tan";
                     break;
                 case "<<Information>>": return "Khaki";
                     break;
                 case "<<Artifact>>": return "Azure";
                     break;
                 case "<<Material>>": return "Pink";
                     break;
                 case "<<Document>>": return "SeaShell";
                     break;
                 case "<<Resource>>": return "Sienna";
                     break;
                 case "<<HumanResource>>": return "Beige";
                     break;
                 case "<<InanimateResource>>": return "Orchid";
                     break;
        ...
        public ActivityDiagramNodeData()
        {
        }
